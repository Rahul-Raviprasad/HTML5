...
/**
* @param {Integer} frameCount number of frames count
*/
...
/**
* @param {Object} c the context object of the canvas
* @param {Boolean} drawShadow whether to draw shadow or not.
*/
